...
class Processor:
    def __init__(self, app_colab):
        ...
        idioma_easyocr, _ = self.utilities.obtener_abreviacion_idioma(self.app_colab.dropdown_idioma_entrada.value, "")
        ocr_config = {
    ...
    def procesar_imagenes(self, ruta_carpeta_entrada, ruta_carpeta_salida, nombre_real_archivo, batch_size):
        ...
        self.app_colab.progressbar_procesamiento.value = self.indice_imagen
        ...
        self.app_colab.etiqueta_cantidad_imagenes.value = f"Cantidad de imágenes: {cantidad_imagenes}"

        idioma_entrada = self.app_colab.dropdown_idioma_entrada.value
        ...
        opcion_acciones = self.app_colab.opcion_acciones.value
    ...
    def preparar_imagenes(self, archivo, ruta_carpeta_entrada):
        ...
        for intento in range(3):
            try:
                ...
                paragraph = self.app_colab.opcion_analisis.value == "Por párrafo"
                idioma_entrada = self.app_colab.dropdown_idioma_entrada.value
                self.densidad_globos = self.app_colab.opcion_densidad_globos.value
    ...
    def limpiar_manga_1(self, imagen, imagen_copia, resultados_limpieza, resultados_traduccion, idioma_entrada):
        ...
        for resultado_traduccion in resultados_traduccion:
            ...
            texto_traducido = self.utilities.traducir_texto(texto, self.app_colab.dropdown_idioma_entrada.value, self.app_colab.dropdown_idioma_salida.value)
            if texto_traducido is not None and len(texto_traducido.split()) > 0:
                ...
                continue
            # Muestra la imagen en la celda de código de Colab
            #display(region_alrededor_pil)
        ...
        for resultado_lim in resultados_limpieza:
            ...
            if poligono_lim.intersects(poligono_tra) and porcentaje_interseccion > 10:
                if tipo_limpieza == "Limpieza básica (B/N)":
                    ...
                    if self.app_colab.opcion_analisis.value == "Por párrafo":
